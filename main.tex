...
\thesistitle{Workflow Open-Source per l'utilizzo della Stampa 3D in Ambito Odontoiatrico} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\department{\href{http://department.university.com}{Dipartimento Discipline Chirurgiche, Oncologiche e Stomatologiche}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
%--------------------------
% License
\include{Chapters/GNU_License/First_page_license}
...
%\include{Chapters/ChapterSpiegazione}
...
\include{Chapters/GNU_License/GNU_License}
%----------------------------------------------------------------------------------------
